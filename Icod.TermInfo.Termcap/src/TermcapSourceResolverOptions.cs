...
public sealed class TermcapSourceResolverOptions
{
	...
	/// The maximum number of <c>tc=</c> edges permitted from the requested root.
	/// Zero permits only entries which require no parent resolution.
	/// </param>
	public TermcapSourceResolverOptions(
