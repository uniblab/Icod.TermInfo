...
**Status:** frozen; implementation, full Debug validation, and PR Staging validation complete  
...
Audited-head PR Staging run `33712109618` completed successfully across Windows,
Linux, and macOS, including coordinated Staging package verification, installable
`Icod.TermInfo.Tools` package smokes, and all six Windows/Linux/macOS x64/ARM64
archive smoke paths.
