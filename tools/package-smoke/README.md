...
The source is checked in as ordinary C# so package smoke coverage can grow during
0.9 without embedding a miniature C# project inside a Bash or CMD script.
